module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('tracks', 'upload_date', {
        transaction,
      });

      await queryInterface.removeColumn('tracks', 'play_count', {
        transaction,
      });

      await queryInterface.removeColumn('tracks', 'artistId', { transaction });

      await queryInterface.removeColumn('tracks', 'description', {
        transaction,
      });

      await queryInterface.removeColumn('tracks', 'title', { transaction });
      ...
      await queryInterface.removeColumn('contests', 'end_date', {
        transaction,
      });

      await queryInterface.removeColumn('contests', 'start_date', {
        transaction,
      });

      await queryInterface.removeColumn('contests', 'name', { transaction });

      await queryInterface.removeColumn('comments', 'comment_date', {
        transaction,
      });

      await queryInterface.removeColumn('comments', 'trackId', { transaction });
      ...
      await queryInterface.dropTable('contests', { transaction });
