                    ...
                    {users.notifications_user &&
                      ...
                      users.notifications_user.map((item: any) => (
                        ...
                        >
                          ...
                          <td data-label='notification_date'>
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.tracks_artist &&
                      Array.isArray(users.tracks_artist) &&
                      users.tracks_artist.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(`/tracks/tracks-view/?id=${item.id}`)
                          }
                        >
                          ...
                          <td data-label='play_count'>{item.play_count}</td>
