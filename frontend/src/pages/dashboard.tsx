...
const Dashboard = () => {
  ...
  const [comments, setComments] = React.useState('Loading...');
  const [contests, setContests] = React.useState('Loading...');
  const [notifications, setNotifications] = React.useState('Loading...');
  const [tracks, setTracks] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_CONTESTS') && (
          ...
          {hasPermission(currentUser, 'READ_TRACKS') && (
