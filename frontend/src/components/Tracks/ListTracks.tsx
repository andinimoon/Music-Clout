...
const ListTracks = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_TRACKS');
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>PlayCount</p>
                    <p className={'line-clamp-2'}>{item.play_count}</p>
                  </div>
